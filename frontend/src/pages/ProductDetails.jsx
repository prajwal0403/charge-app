...
const StationDetails = () => {
  ...
  useEffect(() => {
    ...
    const handleDelete = async (stationId) => {
      try {
        ...
        setStation(station.filter((station) => station.id !== stationId));
  ...
  if (!station) {
    return <div className="text-center mt-10 text-lg text-gray-600">Loading Station Details...</div>;
  }
      ...
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="px-6 py-8">
          ...
          <div className="mt-8 flex gap-4 justify-end border-t pt-6">
            ...
            <button  onClick={() => handleDelete(station.id)} className="cursor-pointer px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors">
              Delete Station
            </button>
          </div>
        } 
